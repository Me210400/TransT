...
def run_webcam(debug=None, visdom_info=None):
    ...
    tracker = Tracker('transt', 'transt50')
    return tracker.run_webcam(debug, visdom_info)


def main():
    parser = argparse.ArgumentParser(description='Run the tracker on your webcam.')
    parser.add_argument('--tracker_name', default='transt', type=str, help='Name of tracking method.')
    parser.add_argument('--tracker_param', default='transt50', type=str, help='Name of parameter file.')
    ...
    run_webcam(args.debug, visdom_info)
